...
public class TorusKnotGeometry extends BaseGeometry {

  public static final String MODEL_NAME_VALUE = "TorusKnotGeometryModel";
  ...
  private String type = "TorusKnotGeometry";
  ...
  public TorusKnotGeometry() {
    ...
    public TorusKnotGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
