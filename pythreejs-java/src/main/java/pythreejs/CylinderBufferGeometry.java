...
public class CylinderBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "CylinderBufferGeometryModel";
  ...
  private String type = "CylinderBufferGeometry";
  ...
  public CylinderBufferGeometry() {
    ...
    public CylinderBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
