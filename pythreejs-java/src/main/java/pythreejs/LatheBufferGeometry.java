...
public class LatheBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "LatheBufferGeometryModel";
  ...
  private String type = "LatheBufferGeometry";
  ...
  public LatheBufferGeometry() {
    ...
    public LatheBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
