...
public class Box3 extends ThreeWidget {

  public static final String MODEL_NAME_VALUE = "Box3Model";
  public static final String MAX = "max";
  public static final String MIN = "min";

  private List max = Arrays.asList(0, 0, 0);
  private List min = Arrays.asList(0, 0, 0);
  ...
  public Box3() {
    ...
    public Box3(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
