...
public class IcosahedronGeometry extends BaseGeometry {

  public static final String MODEL_NAME_VALUE = "IcosahedronGeometryModel";
  ...
  private String type = "IcosahedronGeometry";
  ...
  public IcosahedronGeometry() {
    ...
    public IcosahedronGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
