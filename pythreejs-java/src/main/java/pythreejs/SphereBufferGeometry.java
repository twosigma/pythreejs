...
public class SphereBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "SphereBufferGeometryModel";
  ...
  private String type = "SphereBufferGeometry";
  ...
  public SphereBufferGeometry() {
    ...
    public SphereBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
