...
public class RingBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "RingBufferGeometryModel";
  ...
  private String type = "RingBufferGeometry";
  ...
  public RingBufferGeometry() {
    ...
    public RingBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
