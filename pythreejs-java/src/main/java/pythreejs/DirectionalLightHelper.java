...
public class DirectionalLightHelper extends Object3D {
  ...
  public static final String MODEL_NAME_VALUE = "DirectionalLightHelperModel";
  ...
  private String type = "DirectionalLightHelper";
  ...
  public DirectionalLightHelper() {
    ...
    public DirectionalLightHelper(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
      this.color = (String) parameters.getOrDefault(COLOR, (Serializable) this.color);
      this.light = (DirectionalLight) parameters.getOrDefault(LIGHT, (Serializable) this.light);
