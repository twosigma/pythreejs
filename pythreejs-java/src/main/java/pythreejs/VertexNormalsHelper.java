...
public class VertexNormalsHelper extends Object3D {

  public static final String MODEL_NAME_VALUE = "VertexNormalsHelperModel";
  ...
  private String type = "VertexNormalsHelper";
  ...
  public VertexNormalsHelper() {
    ...
    public VertexNormalsHelper(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
