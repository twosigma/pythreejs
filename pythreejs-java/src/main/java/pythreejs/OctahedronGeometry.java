...
public class OctahedronGeometry extends BaseGeometry {

  public static final String MODEL_NAME_VALUE = "OctahedronGeometryModel";
  ...
  private String type = "OctahedronGeometry";
  ...
  public OctahedronGeometry() {
    ...
    public OctahedronGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
