...
public class PlaneBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "PlaneBufferGeometryModel";
  ...
  private String type = "PlaneBufferGeometry";
  ...
  public PlaneBufferGeometry() {
    ...
    public PlaneBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
