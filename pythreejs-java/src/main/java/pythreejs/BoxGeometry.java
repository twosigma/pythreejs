...
public class BoxGeometry extends BaseGeometry {
  ...
  public static final String MODEL_NAME_VALUE = "BoxGeometryModel";
  ...
  private String type = "BoxGeometry";
  ...
  public BoxGeometry() {
    ...
    public BoxGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
