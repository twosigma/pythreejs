...
public class DodecahedronGeometry extends BaseGeometry {

  public static final String MODEL_NAME_VALUE = "DodecahedronGeometryModel";
  ...
  private String type = "DodecahedronGeometry";
  ...
  public DodecahedronGeometry() {
    ...
    public DodecahedronGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
