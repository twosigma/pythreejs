...
public class TorusGeometry extends BaseGeometry {

  public static final String MODEL_NAME_VALUE = "TorusGeometryModel";
  ...
  private String type = "TorusGeometry";
  ...
  public TorusGeometry() {
    ...
    public TorusGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
