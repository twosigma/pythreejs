...
public class CircleBufferGeometry extends BaseBufferGeometry {

  public static final String MODEL_NAME_VALUE = "CircleBufferGeometryModel";
  ...
  private String type = "CircleBufferGeometry";
  ...
  public CircleBufferGeometry() {
    ...
    public CircleBufferGeometry(LinkedHashMap<String, Serializable> parameters) {
      super(parameters);
